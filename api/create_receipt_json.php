 ...
 * Без local_only рулоны в таблице rolls появятся только после успешной отправки в Б24 и кнопки «Отправить товар на склад» на stock_operations.php.
 * Либо добавьте в JSON: "local_only": true — без документа в Б24; рулоны создаются сразу при проведении прихода.
