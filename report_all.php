...
<div class="card">
<p class="text-muted">
    Это <strong>операционный отчет</strong> за весь период (детализация и сверка операций).
    Для стратегических метрик бизнеса и интерактивной сортировки товаров используйте
