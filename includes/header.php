    ...
    <header class="header">
        <div class="header-content">
            ...
            <nav class="nav" aria-label="Основная навигация">
                ...
                <a href="sync_monitor_developers.php" class="nav-link <?= $current_page == 'sync_monitor_developers.php' ? 'active' : '' ?>" title="Инструменты для разработчиков"><span class="nav-dev-icon" aria-hidden="true">&lt;/&gt;</span></a>
                <button type="button" class="btn btn-light btn-sm js-theme-toggle header-theme-toggle" title="Светлая и тёмная тема"><span aria-hidden="true">🌓</span> Тема</button>
            </nav>
        </div>
    </header>
