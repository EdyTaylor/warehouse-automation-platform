...
<main class="container">
        ...
        <div class="card">
            <h3>📈 Дашборд руководителя</h3>
            <p>Вынесен в отдельную вкладку для управленческой аналитики и динамики.</p>
            <a href="manager_dashboard.php" class="btn btn-primary">Открыть дашборд руководителя</a>
        </div>
