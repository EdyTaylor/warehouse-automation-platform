...
<div class="card">
<p class="text-muted">
    Это <strong>операционный отчет</strong> за месяц (детализация и контроль операций).
    Для управленческой аналитики по прибыльности/марже/динамике используйте
    <a href="manager_dashboard.php">«Руководитель»</a>.
</p>
</div>
...
?>
<h3>Итого выручка (факт): <?php echo number_format($sumRevenue, 2, '.', ' '); ?></h3>
<?php $sumPlanned = floatval(isset($total['total_planned']) ? $total['total_planned'] : 0); ?>
<h3>Итого по типу (план): <?php echo number_format($sumPlanned, 2, '.', ' '); ?></h3>
